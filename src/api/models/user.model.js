...
const userSchema = new mongoose.Schema({
  ...
  login_as: {
    type: String,
    enum: ['GUARD', 'CLEANER','CLIENT','VENDOR','SUPERADMIN','CLIENT_USER','COMPANY_CLIENT'],
    required: true,
    default:'GUARD'
  },
...
userSchema.method({
  transform() {
    const transformed = {};
    const fields = ['id', 'name', 'email','firstname', 'lastname', 'picture', 'role', 'phone', 'country', 'postcode', 'about', 'licenseNumber', 'expiryDate', 'agreeTermAndCondition','experiences', 'agreeWithPrivacyPolicy','login_as', 'createdAt'];
