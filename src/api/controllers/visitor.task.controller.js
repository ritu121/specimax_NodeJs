...
const Task = require('../models/visitor.task.model');
...
exports.load = async (req, res, next, id) => {
  try {
    ...
    req.locals = { task };
    console.log('in loada',req.locals.task)
    return next();
  } catch (error) {
    return next(error);
  }
...
exports.updateStatus = async(req,res,next)=>{
  console.log('req....',req.body,req.locals.task)
  // return 
...
exports.visitorList = async(req,res,next)=>{
  res.json({code: 200, message: 'Visitor list retrieved successfully.', data: []});
