...
exports.update = async (req, res, next) => {
  ...
  // const updateData = await Question.updateOne({_id : req.params.questionId}, req.body, function(err, data){
  //   res.json({code : 200, message : 'Question updated successfully.', data: data})
  // });
  question.save()
