...
const {
  ...
  replaceTracker,
  updateTracker,
} = require('../../validations/tracker.validation');
 ...
 */
router.param('trackerId', controller.load);
...
router
   ...
   */
  .get(authorize(ADMIN_USER), validate(listTrackers), controller.list)
  /**
   ...
   */
  .post(authorize(ADMIN_USER), validate(createTracker), controller.create);
...
router
   ...
   * @apiError (Not Found 404)    NotFound Tracker does not exist
   */
  .put(authorize(ADMIN_USER), validate(replaceTracker), controller.replace)
  /**
   ...
   * @apiError (Not Found 404)    NotFound Tracker does not exist
   */
  .patch(authorize(ADMIN_USER), validate(updateTracker), controller.update)
  /**
