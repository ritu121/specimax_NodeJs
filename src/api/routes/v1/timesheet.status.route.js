...
const controller = require('../../controllers/timesheet.status.controller');
...
const {
  ...
  replaceStatus,
  updateStatus,
} = require('../../validations/timesheet.status.validation');
...
router
   ...
   */
  .get(authorize(), validate(listStatuses), controller.list)
  /**
