...
router
   ...
   */
  .get(authorize(ADMIN_USER), validate(listRoles), controller.list)
  /**
   ...
   */
  .post(authorize(ADMIN_USER), validate(createRole), controller.create);
...
router
   ...
   * @apiError (Not Found 404)    NotFound Tracker does not exist
   */
  .put(authorize(ADMIN_USER), validate(replaceRole), controller.replace)
  /**
   ...
   * @apiError (Not Found 404)    NotFound Tracker does not exist
   */
  .patch(authorize(ADMIN_USER), validate(updateRole), controller.update)
  /**
