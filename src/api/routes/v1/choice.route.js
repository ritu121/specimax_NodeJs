...
const {
  ...
  replaceChoice,
  updateChoice,
} = require('../../validations/choice.validation');
 ...
 */
router.param('choiceId', controller.load);
...
router
   ...
   */
  .get(authorize(ADMIN), validate(listChoices), controller.list)
  /**
   ...
   */
  .post(authorize(ADMIN), validate(createChoice), controller.create);
...
router
   ...
   * @apiError (Not Found 404)    NotFound Tracker does not exist
   */
  .put(authorize(ADMIN_USER), validate(replaceChoice), controller.replace)
  /**
   ...
   * @apiError (Not Found 404)    NotFound Tracker does not exist
   */
  .patch(authorize(ADMIN_USER), validate(updateChoice), controller.update)
  /**
